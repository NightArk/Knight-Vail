...
public class TownBairdDialogue : MonoBehaviour
{
    ...
    {
        { "Let it be bright and full of cheer!", "Let it be deep, with a touch of sorrow…" },
        { "I swing my sword with pride!", "I win with clever words and plans!" },
        { "A brave and loyal horse.", "A cheeky frog who talks too much!" },
        { "Songs sung of me for years to come!", "Only whispers… and a mystery." }
    };
