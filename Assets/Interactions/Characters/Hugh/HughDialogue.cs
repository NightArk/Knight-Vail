...
public class HughDialogue : MonoBehaviour
{
    [System.Serializable]
    ...
    {
        speaker = "Hugh",
        line = "Please... be careful out there."
    };
    ...
    void Start()
    {
        ...
        {
            new DialogueLine { speaker = "Hugh", line = "Oh—thank the stars, someone’s here!" },
            new DialogueLine { speaker = "Hugh", line = "We’re trapped. The road's crawling with monsters—we can’t even get to town." },
            new DialogueLine { speaker = "Hugh", line = "They came from the woods last night... surrounded the farm. No one's slept a wink." },
            new DialogueLine { speaker = "Hugh", line = "I tried to fight them off myself, but they were too many, too fierce. I barely escaped with my life." },
            new DialogueLine { speaker = "Hugh", line = "Please, if you have any skill with a blade or spell—can you help us clear them out?" },
            new DialogueLine { speaker = "Axel", line = "I’ll handle it. Stay hidden until it’s safe." },
            new DialogueLine { speaker = "Hugh", line = "Be careful. They’re dangerous and won’t give up easily." }
        };
